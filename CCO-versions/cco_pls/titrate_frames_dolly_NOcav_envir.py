...
if __name__ == '__main__':
    ...
    chunk100 = np.arange(0, 501, 100)
    chunk50 = np.arange(0, 501, 50)
    chunk20 = np.arange(0, 501, 20)
    chunk10 = np.arange(0, 501, 10)
    chunk4 = np.arange(0, 501, 4)
    chunk2 = np.arange(0, 501, 2)
    ...
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/PF_xtra/prd/10ang_no_cavities_voda/'
    # workfolder = titration_folder + 'md_PF_prd-/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prd-_xtra6/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'no_cav_10ang_md_PF_prd-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_PF_prdh1/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prdh1_xtra6/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'no_cav_10ang_md_PF_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_PF_prdh2/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prdh2_xtra6/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'no_cav_10ang_md_PF_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])


    frame_range = [20, 100, 180, 260, 340]

    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/PF_xtra/prd/10ang_no_cavities_voda_tapbs01/'
    workfolder = titration_folder + 'md_PF_prd-/'
    workfolder1 = workfolder
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prd-_xtra6/%s/' % frames_suffix
    state = 'PF'
    md_name = 'tapbs01_10ang_md_PF_prd-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True], dolly='D64')


    frame_range = [20, 100, 180, 260, 340]
    workfolder = titration_folder + 'md_PF_prdh1/'
    workfolder2 = workfolder
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prdh1_xtra6/%s/' % frames_suffix
    state = 'PF'
    md_name = 'tapbs01_10ang_md_PF_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True], dolly='D63')

    while True:
        for frame in frame_range:
            comp_done = os.path.exists(workfolder1 + '/frame%s/results.pkl' % frame)
            if comp_done == False:
                break
        if comp_done:
            break
    ...
    while True:
        for frame in frame_range:
            comp_done = os.path.exists(workfolder2 + '/done/frame%s/results.pkl' % frame)
            if comp_done == False:
                break
        if comp_done:
            break
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prdh2_xtra6/%s/' % frames_suffix
    state = 'PF'
    md_name = 'tapbs01_10ang_md_PF_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True], dolly='D61')


    frame_range = [20, 100, 180]
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/F_xtra/prd/10ang_no_cavities_voda_tapbs01/'
    workfolder = titration_folder + 'md_F_prd-/'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prd-_xtra6/%s/' % frames_suffix
    state = 'F'
    md_name = 'tapbs01_10ang_md_F_prd-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
    ...
    workfolder = titration_folder + 'md_F_prdh1/'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prdh1_xtra6/%s/' % frames_suffix
    state = 'F'
    md_name = 'tapbs01_10ang_md_F_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True], dolly='D64')
    ...
    workfolder = titration_folder + 'md_F_prdh2/'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prdh2_xtra6/%s/' % frames_suffix
    state = 'F'
    md_name = 'tapbs01_10ang_md_F_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True], dolly='D63')
    ...
    #             'LYS-227_BCHA', 'TYR-336_ACHA', \
    #             'TYR-415_ACHA', 'ARG-408_ACHA', 'TYR-175_ACHA']
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/F_xtra/prd/10ang_no_cavities_voda/'
    #
    # workfolder = titration_folder + 'md_F_prd-/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prd-_xtra6/%s/' % frames_suffix
    # state = 'F'
    # md_name = 'no_cav_10ang_md_F_prd-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_F_prdh1/'
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prdh1_xtra6/%s/' % frames_suffix
    # state = 'F'
    # md_name = 'no_cav_10ang_md_F_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_F_prdh2/'
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prdh2_xtra6/%s/' % frames_suffix
    # state = 'F'
    # md_name = 'no_cav_10ang_md_F_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    # state = 'F'
    # md_name = 'no_cav_10ang_F_pra-_a3'
    ...
    # state = 'F'
    # md_name = 'no_cav_10ang_F_prah1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
    #                          cavities=[],
    #                          membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'F'
    # md_name = 'no_cav_10ang_F_prah2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
    #                          cavities=[],
    #                          membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_pra-/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'no_cav_10ang_PF_pra-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
    #                          cavities=[],
    #                          membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_prah1/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'no_cav_10ang_PF_prah1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
    #                          cavities=[],
    #                          membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_prah2/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'no_cav_10ang_PF_prah2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
    #                          cavities=[],
    #                          membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_pra-/%s/' % frames_suffix
    state = 'PF'
    md_name = 'tapbs01_10ang_PF_pra-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
                             cavities=[],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True], dolly='D64')
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_prah1/%s/' % frames_suffix
    state = 'PF'
    md_name = 'tapbs01_10ang_PF_prah1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
                             cavities=[],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True], dolly='D63')
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_prah2/%s/' % frames_suffix
    state = 'PF'
    md_name = 'tapbs01_10ang_PF_prah2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
                             cavities=[],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True], dolly='D64')
    # while True:
