...
def titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=None, cavities=False,
                             membrane_charge=True, kbp2_eval_titration=False, glu_asp_lys_patch=[False, False, True]):
...
"""
    ...
    #                          )
    #
    # # shell.stdin.write('qsub -q D47.q,D49.q,D50.q,D51.q,D61.q,D62.q,D63.q,D64.q -o %s -e %s %s\n' % (run_folder, run_folder, submitt_script_file) )
    # # shell.stdin.write('qsub -q D47.q,D49.q,D50.q,D51.q -o %s -e %s %s\n' % (run_folder, run_folder, submitt_script_file) )
...
if __name__ == '__main__':
    ...
    titration_folder = '/work/jdragelj/projects/tests/dolly/'
    ...
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/mnt/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_pra-/%s/' % frames_suffix
    frame_range = np.arange(0, 801, 2)
    state = 'Pr'
    md_name = '10_md_Pr_prah1_a3'
    ...
    # #####################################################################################
    #
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra_a3/10ang_voda/'
    # frames_suffix = 'frames_voda/'
    # residues = ['PRD-3_EHEM','PRA-1_EHEM','PRD-3_GHEM','PRA-1_GHEM','ARG-481_ACHA', 'ARG-482_ACHA', 'GLU-286_ACHA', 'ASP-407_ACHA', 'HSD-411_ACHA', \
    #             'ASP-412_ACHA', 'ARG-52_ACHA', 'TYR-414_ACHA', 'ASP-229_BCHA', 'LYS-227_BCHA', 'TYR-336_ACHA', 'TYR-415_ACHA', 'ARG-408_ACHA', 'TYR-175_ACHA']
    #
    ...
    # #####################################################################################
    #
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra/10ang_voda/'
    # frames_suffix = 'frames_voda/'
    # residues = ['PRD-3_EHEM','PRA-1_EHEM','PRD-3_GHEM','PRA-1_GHEM','ARG-481_ACHA', 'ARG-482_ACHA', 'GLU-286_ACHA', 'ASP-407_ACHA', 'HSD-411_ACHA', \
    #             'ASP-412_ACHA', 'ARG-52_ACHA', 'TYR-414_ACHA', 'ASP-229_BCHA', 'LYS-227_BCHA', 'TYR-336_ACHA', 'TYR-415_ACHA', 'ARG-408_ACHA', 'TYR-175_ACHA']
    #
    ...
    # md_name = 'md_prah1_a'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = False,
    #                          membrane_charge = False, kbp2_eval_titration = True)
    #
    # workfolder = titration_folder + 'md_prah2/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    ...
    #
    #
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_prd/10ang_voda/'
    # frames_suffix = 'frames_voda/'
    # residues = ['PRD-3_EHEM','PRA-1_EHEM','PRD-3_GHEM','PRA-1_GHEM','ARG-481_ACHA', 'ARG-482_ACHA', 'GLU-286_ACHA', 'ASP-407_ACHA', 'HSD-411_ACHA', \
    #             'ASP-412_ACHA', 'ARG-52_ACHA', 'TYR-414_ACHA', 'ASP-229_BCHA', 'LYS-227_BCHA', 'TYR-336_ACHA', 'TYR-415_ACHA', 'ARG-408_ACHA', 'TYR-175_ACHA']
    #
    ...
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = '10_md_Pr_prdh2'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = False,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])

    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_md_crystal/'
    # frames_suffix = 'frames_voda/'
    #
    # workfolder = titration_folder + '10ang_voda/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_crystal/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'md_Pr_crystal'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = False,
    #                          membrane_charge = False, kbp2_eval_titration = True)
