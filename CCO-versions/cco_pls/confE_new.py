...
"""
    ...
    for test in tests:
        ...
        pdb_structure_og = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/new_models/PRD_H_PRA_a3/final_models/titrate_c_pf_f/combo_prdh.pdb'
...
#         print 'crystal', ft
#         modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_prd_a3/minimized/crystal/e80_05_test/crystal_min_w%s/' % (ft)
#         run_folder = modelling_folder + 'apbs/'
...
#
#         print 'model', ft
#         modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_prd_a3/minimized/model/e80_05_test/model_min_w%s/' % (ft)
#         run_folder = modelling_folder + 'apbs/'
#         apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
#         charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
...
#         energies = []
#         for frame in frames:
#             modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_prd_a3/frames_small/xtra/e80_05_frames_test%s/crystal/f%i/crystal_f%i_w%s/' % (ft, frame, frame,ft)
#             run_folder = modelling_folder + 'apbs/'
#             apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
#             charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
...
#         energies = []
#         for frame in frames:
#             modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_prd_a3/frames_small/xtra/e80_05_frames_test%s/model/f%i/model_f%i_w%s/' % (ft, frame, frame,ft)
#             run_folder = modelling_folder + 'apbs/'
#             apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
#             charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
...
#         plt.ylim(0,700)
#         plt.savefig('/user/jdragelj/Desktop/PRD_ConfE_25ns.png' )
#
#
#
