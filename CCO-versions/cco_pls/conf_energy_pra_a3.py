...
def conf_energy_computation(pdb_structure_cco, modelling_folder, jobname, cavity_parameter=None, apbs=False, small=None,
                            propionic_patch=None, glu_deprot=False, asp_deprot=False):
...
define small sele ((resid 44 .and. segid ACHA) -
.or.(resid 48 .and. segid ACHA) -
.or.(resid 51:55 .and. segid ACHA) -
.or.(resid 95:112 .and. segid ACHA) -
.or.(resid 169:179 .and. segid ACHA) -
.or.(resid 194 .and. segid ACHA) -
.or.(resid 242:243 .and. segid ACHA) -
.or.(resid 246 .and. segid ACHA) -
.or.(resid 249 .and. segid ACHA) -
.or.(resid 250 .and. segid ACHA) -
.or.(resid 253 .and. segid ACHA) -
.or.(resid 273 .and. segid ACHA) -
.or.(resid 275:291 .and. segid ACHA) -
.or.(resid 327:328 .and. segid ACHA) -
.or.(resid 330:338 .and. segid ACHA) -
.or.(resid 340 .and. segid ACHA) -
.or.(resid 348 .and. segid ACHA) -
.or.(resid 352 .and. segid ACHA) -
.or.(resid 355 .and. segid ACHA) -
.or.(resid 391 .and. segid ACHA) -
.or.(resid 393:429 .and. segid ACHA) -
.or.(resid 467:468 .and. segid ACHA) -
.or.(resid 471:472 .and. segid ACHA) -
.or.(resid 475 .and. segid ACHA) -
.or.(resid 479 .and. segid ACHA) -
.or.(resid 480:483 .and. segid ACHA) -
.or.(resid 216:218 .and. segid BCHA) -
.or.(resid 227:229 .and. segid BCHA) -
.or.(resid 252:256 .and. segid BCHA) -
.or.(resid 260 .and. segid BCHA) -
.or.(resid 263 .and. segid BCHA) -
.or.(resid 126:128 .and. segid BCHA) -
.or.(resid 122:123 .and. segid BCHA) -
.or.(resid 48:54 .and. segid BCHA) -
.or.(resid 225:226 .and. segid BCHA) -
.or.(resid 220 .and. segid BCHA) -
.or.(resid 222 .and. segid BCHA) -
.or.(resid 238:239 .and. segid BCHA) -
.or.(resid 129 .and. segid BCHA) -
.or.(resid 236 .and. segid BCHA) -
.or.(resid 345 .and. segid ACHA) -
.or.(resid 349 .and. segid ACHA) -
.or.(resid 339 .and. segid ACHA) -
.or.(resid 341:342 .and. segid ACHA) -
.or.(resid 1 .and. segid FEOH) -
.or. segid GHEM .or. segid EHEM -
.or.(resid 1 .and. segid HOHC) -
.or.(resid 1:4 .and. segid META) -
.or. segid VODA) end
    """
    ...
    # for test in tests:
    #     for prot in ['h1', 'h2']:
    #         ##### MOVED AND MINIMIZED MODEL PRA PROTONATED MIN ######
    #         # pdb_structure_og = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/model%s/cco_pra%s_protmin2.pdb' % (prot, prot)
    #
    #         if prot == 'h1':
    #             pp = 'h'
    #         if prot == 'h2':
    #             pp = '2'
    #
    #         pdb_structure_og = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/move/cco_moved_mini_pra%s_envir4.pdb' % (pp)
    #         test_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/model%s/e80_05_test%s/' % (prot, test)
    #         if not os.path.exists(test_folder):
    #             os.mkdir(test_folder)
    #         pdb_structure_w = test_folder + '/m_min_cco_voda%s.pdb' % test
    #         jobname  = 'model%s_min_w%s' % (prot, test)
    ...
    #                                     small=string, propionic_patch=propionic_patch, asp_deprot=True)
    #
    #     ##### MINIMIZED CRYSTAL STRUCTURE ######
    #     # pdb_structure_og = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/cco_and_water_protmin2.pdb'
    ...
    #     test_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e80_05_test%s/' % test
    #     if not os.path.exists(test_folder):
    #         os.mkdir(test_folder)
    ...
    #     for prot in ['h1', 'h2']:
    #         for frame in frames:
    #             pdb_structure_og = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_pra%s/frames_voda/frame%i.pdb' % (prot, frame)
    #             run_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/frames_small/e80_05_frames_test%s/model%s/f%i/' % (test, prot, frame)
    #             pdb_structure_w = run_folder + '/mod_cco_voda%s.pdb' % test
    #             jobname  = 'model%s_f%i_w%s' % (prot, frame, test)
    ...
    #                 continue
        ...
        # for frame in frames:
        #     pdb_structure_og = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/crystal_mds/md_Pr_crystal/frames_voda/frame%i.pdb' % (frame)
        #     run_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/frames_small/e80_05_frames_test%s/crystal/f%i/' % (test, frame)
...
#
    ...
    for ft in frames_tests:
        # ################# small ##############################
        # print 'crystal res 0.5 no cav', ft
        # # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e20_05_small_test%s/crystal_min_w%s/' % (ft,ft)
        # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e80_05_nocav_test/crystal_min_w%s/' % (ft)
        # run_folder = modelling_folder + 'apbs/'
        ...
        print 'crystal res 0.5 with cav', ft
        # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e20_05_small_test%s/crystal_min_w%s/' % (ft,ft)
        modelling_folder = '/mnt/fu-scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e80_05_test/crystal_min_w%s/' % (ft)
        run_folder = modelling_folder + 'apbs/'
        apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
        charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
        conf_energy_crystal = apbs_energy + charmm_energy['ELEC'][0]
        ...
        # print 'crystal res 0.3 no cav', ft
        # # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e20_05_small_test%s/crystal_min_w%s/' % (ft,ft)
        # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e80_nocav_test/crystal_min_w%s/' % (ft)
        # run_folder = modelling_folder + 'apbs/'
        # apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
        # charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
        # conf_energy_crystal = apbs_energy + charmm_energy['ELEC'][0]
        # print "**********Conf energy: %.2f KJ/mol (apbs %.2f, coulomb %.2f)" % (conf_energy_crystal, apbs_energy, charmm_energy['ELEC'][0])
        #
        # print 'crystal res 0.3 with cav', ft
        # # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e20_05_small_test%s/crystal_min_w%s/' % (ft,ft)
        # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/crystal/e80_test/crystal_min_w%s/' % (ft)
        # run_folder = modelling_folder + 'apbs/'
        # apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
        # charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
        # conf_energy_crystal = apbs_energy + charmm_energy['ELEC'][0]
        ...
        print 'modelh1', ft
        # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/modelh1/e20_05_small_test%s/modelh1_min_w%s/' % (ft,ft)
        modelling_folder = '/mnt/fu-scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/modelh1/e80_05_test/modelh1_min_w%s/' % (ft)
        run_folder = modelling_folder + 'apbs/'
        apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
        # inter_energy = kbp2.charmm.get_charmm_energy(modelling_folder, inter=True)
        charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
        # conf_energy_modelh1 = apbs_energy + inter_energy['ELEC'][0] + charmm_energy['ELEC'][0]
        conf_energy_modelh1 = apbs_energy + charmm_energy['ELEC'][0]
        print "**********Conf energy: %.2f KJ/mol (apbs %.2f, coulomb %.2f)" % (conf_energy_modelh1, apbs_energy, charmm_energy['ELEC'][0])
        print '***********'
        print 'Econf(crystal)-Econf(modelh1)=%.2f KJ/mol' %(conf_energy_crystal-conf_energy_modelh1)
        print '***********'

        print 'modelh2', ft
        # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/modelh2/e20_05_small_test%s/modelh2_min_w%s/' % (ft,ft)
        modelling_folder = '/mnt/fu-scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/minimized/modelh2/e80_05_test/modelh2_min_w%s/' % (ft)
        run_folder = modelling_folder + 'apbs/'
        apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
        # inter_energy = kbp2.charmm.get_charmm_energy(modelling_folder, inter=True)
        charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
        # conf_energy_modelh2 = apbs_energy + inter_energy['ELEC'][0] + charmm_energy['ELEC'][0]
        conf_energy_modelh2 = apbs_energy + charmm_energy['ELEC'][0]
        print "**********Conf energy: %.2f KJ/mol (apbs %.2f, coulomb %.2f)" % (conf_energy_modelh2, apbs_energy, charmm_energy['ELEC'][0])
        print '***********'
        print 'Econf(crystal)-Econf(modelh2)=%.2f KJ/mol' %(conf_energy_crystal-conf_energy_modelh2)
        print '***********'
    ...
    for ft in frames_tests:
        ...
        energies = []
        for frame in frames:
            # modelling_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/frames_small/e80_05_frames_test%s/crystal/f%i/crystal_f%i_w%s/' % (ft,frame, frame,ft)
            ...
            if (conf_energy_closed_w + 52000) < -20000:
                print frame
        ...
        energies = []
        for frame in frames:
            modelling_folder = '/mnt/fu-scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/frames_small/e80_05_frames_test%s/modelh1/f%i/modelh1_f%i_w%s/' % (ft,frame, frame,ft)
            run_folder = modelling_folder + 'apbs/'
            apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
            charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
        ...
        print 'diff modelh1', avgEc - avgEm
        ...
        print len(energies), len(avgC)

        # ax1.plot(frame_scale, energies, lw=1.0, color='black')
        ax1.plot(frame_scale, energies, lw=1.0, color='purple')
        ax1.plot(frame_scale, avgM, lw=1.0, linestyle='--', color='purple')

        energies1 = []
        for frame in frames:

            modelling_folder = '/mnt/fu-scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/conf_ene_Pr_pra_a3/frames_small/e80_05_frames_test%s/modelh2/f%i/modelh2_f%i_w%s/' % (ft,frame, frame,ft)
            run_folder = modelling_folder + 'apbs/'
            apbs_energy, coulomb_energy = kbp2.apbs_manager.read_result(run_folder, epsilon=4.0)
            charmm_energy = get_charmm_energy_many(modelling_folder, k=1)
            conf_energy_open_w = apbs_energy + charmm_energy['ELEC'][0]
            energies1.append(conf_energy_open_w + 53200)
        avgEm = sum(energies1) / len(energies1)
        print 'diff modelh2', avgEc - avgEm
        ...
        # ax1.plot(frame_scale, energies1, lw=1.0, color='blue')

        ax1.plot(frame_scale, energies1, lw=1.0, color='black')
        ax1.plot(frame_scale, avgM, lw=1.0, linestyle='--', color='black')
        ...
        plt.ylim(0,700)
        plt.savefig('/home/users/j/jdragelj/Desktop/PRA_ConfE_25ns.png' )
