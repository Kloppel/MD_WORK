...
def titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=None, cavities=[],
    ...
    if cavities:
        ...
        # kbp2_settings.cavity_par = [0.9, 0.2, 0.0]
...
"""
    ...
    # shell.stdin.write('qsub -q D62.q -o %s -e %s %s\n' % (run_folder, run_folder, submitt_script_file) )
    shell.stdin.write('qsub -q D61.q,D62.q -o %s -e %s %s\n' % (run_folder, run_folder, submitt_script_file) )
...
if __name__ == '__main__':
    ...
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/PF_xtra/prd/10ang_cavities_09_voda/'
    ...
    # state = 'PF'
    # md_name = 'cav_09_10ang_md_PF_prd-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    workfolder = titration_folder + 'md_PF_prd-2/'
    frames_suffix = 'frames_voda2'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prd-_xtra6/%s/' % frames_suffix
    state = 'PF'
    md_name = 'cav_09_10ang_md_PF_prd-2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    # state = 'PF'
    # md_name = 'cav_09_10ang_md_PF_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'PF'
    # md_name = 'cav_09_10ang_md_PF_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    # ######################################################################################################################################################

    # frame_range = chunk2
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/PF_xtra/prd/10ang_cavities_08_voda/'
    # workfolder = titration_folder + 'md_PF_prd-/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prd-_xtra6/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'cav_08_10ang_md_PF_prd-_a3'
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prdh1_xtra6/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'cav_08_10ang_md_PF_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_PF_prdh2/'
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_PF/md_PF_prdh2_xtra6/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'cav_08_10ang_md_PF_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    # state = 'PF'
    # md_name = 'cav_09_10ang_PF_pra-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'PF'
    # md_name = 'cav_09_10ang_PF_prah1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'PF'
    # md_name = 'cav_09_10ang_PF_prah2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_pra-/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'cav_08_10ang_PF_pra-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.8, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_prah1/'
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_prah1/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'cav_08_10ang_PF_prah1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.8, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    #
    # workfolder = titration_folder + 'md_prah2/'
    ...
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/PF_state/md_prah2/%s/' % frames_suffix
    # state = 'PF'
    # md_name = 'cav_08_10ang_PF_prah2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.8, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
