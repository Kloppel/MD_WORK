...
if __name__ == '__main__':
    ...
    chunk20 = np.arange(0, 601, 20)
    chunk10 = np.arange(0, 601, 10)
    chunk4 = np.arange(0, 601, 4)
    chunk2 = np.arange(0, 601, 2)
    ...
    residues = ['PRD-3_EHEM', 'PRA-1_EHEM', 'PRD-3_GHEM', 'PRA-1_GHEM', 'ARG-481_ACHA', 'ARG-482_ACHA',
                    ...
                    'TYR-415_ACHA', 'ARG-408_ACHA', 'TYR-1 75_ACHA']
    ...
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_xtra/prd/PF/10ang_cavities_09_voda/'
    ...
    state = 'PF'
    md_name = 'cav_09_10ang_Pr-PF_prd-_a3'
    ...
    state = 'PF'
    md_name = 'cav_09_10ang_Pr-PF_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    state = 'PF'
    md_name = 'cav_09_10ang_Pr-PF_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_xtra/prd/Pm/10ang_cavities_09_voda/'
    workfolder = titration_folder + 'md_Pr_prd-/'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prd-_xtra6/%s/' % frames_suffix
    state = 'Pm'
    md_name = 'cav_09_10ang_Pr-Pm_prd-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
                             cavities=[0.9, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prdh1_xtra6/%s/' % frames_suffix
    state = 'Pm'
    md_name = 'cav_09_10ang_Pr-Pm_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
                             cavities=[0.9, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prdh2_xtra6/%s/' % frames_suffix
    state = 'Pm'
    md_name = 'cav_09_10ang_Pr-Pm_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=residues,
                             cavities=[0.9, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    #################### PF from Pr ################################
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra_a3/PF/10ang_cavities_09_voda/'
    frames_suffix = 'frames_voda/'
    frame_range = chunk10
    ...
    state = 'PF'
    md_name = 'cav_09_10ang_PrtoPF_pra-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    ...
    state = 'PF'
    md_name = 'cav_09_10ang_PrtoPF_prah1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    state = 'PF'
    md_name = 'cav_09_10ang_PrtoPF_prah2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])


    #################### Pm from Pr ################################
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra_a3/Pm/10ang_cavities_09_voda/'
    frames_suffix = 'frames_voda/'
    frame_range = chunk10
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_pra-/%s/' % frames_suffix
    state = 'Pm'
    md_name = 'cav_09_10ang_PrtoPm_pra-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_prah1/%s/' % frames_suffix
    state = 'Pm'
    md_name = 'cav_09_10ang_PrtoPm_prah1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_prah2/%s/' % frames_suffix
    state = 'Pm'
    md_name = 'cav_09_10ang_PrtoPm_prah2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
