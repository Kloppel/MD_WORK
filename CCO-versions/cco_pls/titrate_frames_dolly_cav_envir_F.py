...
if __name__ == '__main__':
    ...
    # frame_range = chunk2
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/F_xtra/prd/10ang_cavities_09_voda/'
    ...
    # state = 'F'
    # md_name = 'cav_09_10ang_md_F_prd-_a3'
    ...
    # state = 'F'
    # md_name = 'cav_09_10ang_md_F_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'F'
    # md_name = 'cav_09_10ang_md_F_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
    #                          membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ######################################################################################################################################################

    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/F_xtra/prd/10ang_cavities_08_voda/'
    frame_range = chunk2
    workfolder = titration_folder + 'md_F_prd-/'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prd-_xtra6/%s/' % frames_suffix
    state = 'F'
    md_name = 'cav_08_10ang_md_F_prd-_a3'
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prdh1_xtra6/%s/' % frames_suffix
    state = 'F'
    md_name = 'cav_08_10ang_md_F_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_F/md_F_prdh2_xtra6/%s/' % frames_suffix
    state = 'F'
    md_name = 'cav_08_10ang_md_F_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.8, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ######################################################################################################################################################
    ...
    # state = 'F'
    # md_name = 'cav_09_10ang_F_pra-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'F'
    # md_name = 'cav_09_10ang_F_prah1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    #
    ...
    # state = 'F'
    # md_name = 'cav_09_10ang_F_prah2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/F_state/md_pra-/%s/' % frames_suffix
    state = 'F'
    md_name = 'cav_08_10ang_F_pra-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/F_state/md_prah1/%s/' % frames_suffix
    state = 'F'
    md_name = 'cav_08_10ang_F_prah1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/F_state/md_prah2/%s/' % frames_suffix
    state = 'F'
    md_name = 'cav_08_10ang_F_prah2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.8, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])

    # chunk2 = np.arange(0, 401, 2)
    # frame_range = chunk2
    # workfolder = titration_folder + 'md_F_prah_asp_dep/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_F_prah_asp_dep/%s/' % frames_suffix
    # state = 'F'
    # md_name = 'cav_09_10ang_md_F_prah_asp_dep_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
