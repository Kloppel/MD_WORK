...
def titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=None, cavities=False,
                             membrane_charge=True, kbp2_eval_titration=False, glu_asp_lys_patch=[True, True, True]):
    ...
    if cavities:
        ...
        # kbp2_settings.cavity_par = [1.0, 0.25, 0.0]
...
kbp2.pka_calculation.calc_pkas(kbp2_settings, titratable_definitions)
        ...
        submitt_kbp2_job(done_folder=done_folder, run_folder=run_folder, local_dolly_folder=local_dolly_folder,
                            jobname=jobname, md_name=md_name)
...
if __name__ == '__main__':
    ...
    # print 'crystal PRD a3'
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_md_crystal/cavities_voda_prd_a3/'
    # frames_suffix = 'frames_voda/'
    # residues = ['PRD-3_EHEM']
    # workfolder = titration_folder
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/crystal_mds/md_Pr_crystal/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_crystal_prd_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])

    # print'PRA a3'
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra_a3/cavities_voda/'
    # frames_suffix = 'frames_voda/'
    # residues = ['PRA-1_EHEM']
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_pra-/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_pra-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, False, True])
    #
    # workfolder = titration_folder + 'md_prah1/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_prah1/%s/' % frames_suffix
    # frame_range = np.arange(0, 401, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prah1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, False, True])
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a3/md_prah2/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prah2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, False, True])


    # print'PRD a3'
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_prd/cavities_voda/'
    # frames_suffix = 'frames_voda'
    # residues = ['PRD-3_EHEM']
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prd-/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prd-_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prdh1/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
    #
    ...
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prdh2/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])


    print'PRD a3'
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_xtra/prd/map_test_cav_08/'
    frames_suffix = 'frames_voda'
    residues = ['PRD-3_EHEM']
    ...
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prd-/%s/' % frames_suffix
    # frame_range = np.arange(0, 801, 40)
    frame_range = [0,560,320]
    state = 'Pr'
    md_name = 'map_test_cav08_md_Pr_prd-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
    #
    # workfolder = titration_folder + 'md_Pr_prdh1/'
    ...
    # frame_range = np.arange(0, 801, 40)
    # state = 'Pr'
    # md_name = 'cav_nocav_md_Pr_prdh1_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = False,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
    #
    # workfolder = titration_folder + 'md_Pr_prdh2/'
    # if not os.path.exists(workfolder):
    ...
    # frame_range = np.arange(0, 801, 40)
    # state = 'Pr'
    # md_name = 'cav_nocav_md_Pr_prdh2_a3'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = False,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])


    # print'PRA a'
    # titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra/cavities_voda/'
    # frames_suffix = 'frames_voda/'
    # residues = ['PRA-1_GHEM']
    #
    # workfolder = titration_folder + 'md_pra-/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a/md_pra-/%s/' % frames_suffix
    # frame_range = np.arange(0, 601, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_pra-_a'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
    #
    # workfolder = titration_folder + 'md_prah1/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a/md_prah1/%s/' % frames_suffix
    # frame_range = np.arange(0, 601, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prah1_a'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
    #
    # workfolder = titration_folder + 'md_prah2/'
    # if not os.path.exists(workfolder):
    #     os.mkdir(workfolder)
    # frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRA_a/md_prah2/%s/' % frames_suffix
    # frame_range = np.arange(0, 601, 2)
    # state = 'Pr'
    # md_name = 'cav_md_Pr_prah2_a'
    # titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = True,
    #                          membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[True, True, True])
