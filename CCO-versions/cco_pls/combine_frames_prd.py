...
# mds = ['md_Pr_prd-']
# mds = ['md_Pr_prd-_2','md_Pr_prdh1','md_Pr_prdh2']
# mds = ['md_F_prd-','md_F_prdh1','md_F_prdh2']
mds = ['md_F_prd-']
# mds = ['md_PF_prd-','md_PF_prdh1','md_PF_prdh2']
# mds = ['md_Pm_prd-','md_Pm_prdh1','md_Pm_prdh2']
# frames = np.arange(20,221,2)
# frame_range = [20,221]
# frames = np.arange(20,501,2)
# frame_range = [20,501]

frames = np.arange(0, 50, 100)
frame_range = [0,101]
...
titration_folder = '/media/jdragelj/88bc6e86-bfdd-41a3-b3f0-9921ae91f5b7/jovan/backup/scratch/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/F_xtra/prd/10ang_no_cavities_voda/'
...
for md in mds:
    ...
    # results[md+'1'] = folder_result
    results[md] = folder_result

# for md in mds:
#     # frames = np.arange(232, 431, 2)
#     # frame_range = [232, 431]
#     frames = np.arange(170, 231, 2)
#     frame_range = [170, 231]
#     sub_folder = titration_folder + md + '/'
#     # kbp result for the entire MD (empty)
#     folder_result = kbp2.kbp_results.FrameKbpResults()
...
for md, folder_result in results.iteritems():
    ...
    # folder_result.avg_results.calc_protonation_energy()
