...
def titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt=None, cavities=[],
    ...
    for frame in frames_to_do:
        if not os.path.exists(frames_folder + 'F_mgcw/'):
            os.mkdir(frames_folder + 'F_mgcw/')
        ...
        pdb_w.write_pdb(frames_folder + 'F_mgcw/frame%i.pdb'%frame)
        frame_pdb_final = frames_folder + 'F_mgcw/frame%i.pdb'%frame
...
if __name__ == '__main__':
    ...
    chunk80 = np.arange(0, 601, 80)
    chunk40 = np.arange(0, 601, 40)
    ...
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_xtra/prd/F/10ang_cavities_09_voda/'
    ...
    state = 'F'
    md_name = 'cav_09_10ang_Pr_F_prd-_a3'
    ...
    state = 'F'
    md_name = 'cav_09_10ang_Pr_F_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    state = 'F'
    md_name = 'cav_09_10ang_Pr_F_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ...
    print'PRA a3'
    #################### F from Pr ################################
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra_a3/F/10ang_cavities_09_voda/'
    frames_suffix = 'frames_voda/'
    frame_range = chunk10
    ...
    state = 'F'
    md_name = 'cav_09_10ang_PrtoF_pra-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    ...
    state = 'F'
    md_name = 'cav_09_10ang_PrtoF_prah1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    state = 'F'
    md_name = 'cav_09_10ang_PrtoF_prah2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
