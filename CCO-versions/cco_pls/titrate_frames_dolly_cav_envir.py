...
if __name__ == '__main__':
    ...
    state = 'Pr'
    md_name = 'cav_09_10ang_md_Pr_prd-_a3'
    ...
    workfolder = titration_folder + 'md_Pr_prd-_2/'
    if not os.path.exists(workfolder):
        os.mkdir(workfolder)
    frames_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/PRD_a3/open_sb_Pr/md_Pr_prd-_xtra6/%s/' % frames_suffix
    state = 'Pr'
    ...
    state = 'Pr'
    md_name = 'cav_09_10ang_md_Pr_prdh1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    state = 'Pr'
    md_name = 'cav_09_10ang_md_Pr_prdh2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities = [0.9, 0.2, 0.0],
                             membrane_charge=False, kbp2_eval_titration=True, glu_asp_lys_patch=[False, False, True])
    ######################################################################################################################################################
    ...
    state = 'Pr'
    md_name = 'cav_09_10ang_Pr_pra-_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True,glu_asp_lys_patch=[False, False, True])
    ...
    state = 'Pr'
    md_name = 'cav_09_10ang_Pr_prah1_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    state = 'Pr'
    md_name = 'cav_09_10ang_Pr_prah2_a3'
    titrate_structures_dolly(workfolder, frames_folder, frame_range, md_name, state, residues_tt = residues, cavities=[0.9, 0.2, 0.0],
                             membrane_charge = False, kbp2_eval_titration = True, glu_asp_lys_patch=[False, False, True])
    ...
    ############################################
    print'Pr PRA a'
    titration_folder = '/scratch/scratch/jdragelj/projects/cco_pls/prd_pra/open_sb_2GSM/titrate/Pr_pra/10ang_cavities_09_voda/'
    frames_suffix = 'frames_voda/'
    frame_range = np.arange(0, 301, 2)
    residues = ['PRD-3_EHEM', 'PRA-1_EHEM', 'PRD-3_GHEM', 'PRA-1_GHEM', 'ARG-481_ACHA', 'ARG-482_ACHA',
                    'GLU-286_ACHA', \
                    'ASP-407_ACHA', 'HSD-411_ACHA', 'ASP-412_ACHA', 'ARG-52_ACHA', 'TYR-414_ACHA', 'ASP-229_BCHA',
                    'LYS-227_BCHA', 'TYR-336_ACHA', \
